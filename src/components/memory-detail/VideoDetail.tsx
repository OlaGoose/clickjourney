    ...
    <div className="fixed inset-0 z-50 flex flex-col animate-fadeIn bg-black font-sans text-white">
      <div className="sticky top-0 z-10 flex items-center justify-between bg-black/80 backdrop-blur-xl px-4 py-3">
        ...
        <div className="flex items-center gap-4">
          <button type="button" className="rounded-full p-1 hover:bg-white/10" aria-label="Share">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
          ...
          <button type="button" className="rounded-full p-1 hover:bg-white/10" aria-label="Like">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
